...
**Sundown Showdown**, a desert brawl where up to 8 players pick one of four brawlers and fight ten to an arena until one is left, with twin-stick controls on an iPhone or iPad, and
...
Every round starts with everybody picking a brawler (1 to 4 or a click, Enter or LOCK IN; online the round starts when all are locked in or after 20 seconds): **Buck** (shotgun; super: a blast that shoves and smashes crates),
**Viper** (one long slug; super: a railshot through everything), **Boomer** (bombs lobbed over walls; super: a carpet of six) and **Brick** (a hammer and a lot of health; super: a bull rush through crates).
...
charge the super by dealing damage, and keep out of the poison gas as it closes in while day turns to night. The last brawler standing wins; a fallen player watches whoever beat them, and the showdown ends early once no human is left in it.
...
more to land the move, the die's top face is a crit, and every rigged press builds a combo that speeds the bar up. M toggles sound, L switches between Chinese (the default) and English, R plays again (host), Esc leaves.
