...
test/             node --test: the snapshot clock, the Kart and Hog wire formats, the QR encoder, the touch controls, the Fable Theft Auto movement code, its simulation, its CPU players and its killcam
