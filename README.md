...
**Fable Theft Auto 5.1**, a voxel crime sandbox where up to 8 players share one procedurally generated city (free roam with a hit to pull off, Most Wanted, where one player carries the mark and everyone else hunts it, or a three-lap street race through checkpoints where anything goes),
...
client/
  ...
  games/
    ...
    gta/          Fable Theft Auto 5.1: index.js (game module: lifecycle, input, HUD, netcode glue),
                  ...
                  remote.js (a client's copy), predict.js (a client's own body), race.js (the street race's seeded course, its lap plan and sat-nav, testable in node), fx.js, font.js, gta.css
